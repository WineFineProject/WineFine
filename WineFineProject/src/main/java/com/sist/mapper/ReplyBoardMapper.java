...
public interface ReplyBoardMapper {
    ...
    // 작성
    @Insert("INSERT INTO wine_replyboard(wrno,userid,nickname,subject,content,group_id,isreply,secret) "
   		 +"VALUES((SELECT NVL(MAX(wrno)+1,1)),#{nickname},#{subject},#{content} "
