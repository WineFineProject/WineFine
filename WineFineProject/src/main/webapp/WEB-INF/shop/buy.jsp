        ...
        <tbody>
            <tr>
                <th scope="row" class="align-middle">
                    <img :src="vo.poster" class="img-fluid me-5 rounded-circle" style="width: 80px; height: 80px;" alt="">
                </th>
...
<tr>
    <td>
        <select v-model="selectedCoupon" style="width:400px;" class="text-center">
            <option disabled value="">쿠폰을 선택하세요</option>
            <option v-for="coupon in cvo" :key="coupon.couponId" :value="coupon">
            ...
            <i class="fa fa-times text-danger"></i>
                              ...
                              <tr>
                                <td style="border-bottom: none;">
									<input type="text" value="0원" style="width:400px;" class="text-center" 
									onfocus="this.value=''" onblur="if(this.value === '') this.value='0원'">
                                    <button class="btn btn-md  bg-light  " style="margin-left: 5px;">
                                        전액사용
                                    </button>
                                </td>
                            </tr>
                    ...
                    <div class="col-6 ">
                        ...
                        <div class="bg-light rounded">
                            ...
                            <div class="py-4 border-top  justify-content-between use" @click="payment"
                    ...
                    <div style="text-align: center !important; margin-bottom: -40px; margin-top: 110px;">
   						 <button class="btn btn-default winecor" style="width: 150px; color: white; "
