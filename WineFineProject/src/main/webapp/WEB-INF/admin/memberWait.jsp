		...
		<table class="table" style="margin-top: 20px">
			...
			<tbody class="text-center">
				<tr v-show="members.length===0">
					<td colspan="7">가입 대기중인 회원이 없습니다</td>
				</tr>
				<template v-for="(vo, index) in members">
					<tr style="vertical-align: middle;" @click="detailMember(index)">
						...
						<td width="14%"><button type="button" @click="accessBtn(index)" class="btn btn-warning">승인</button>
							<button type="button" @click="deleteBtn(index)" class="btn btn-danger">거절</button></td>
					</tr>
