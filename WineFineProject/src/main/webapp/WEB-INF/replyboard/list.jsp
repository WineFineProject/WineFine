       ...
       <tr>
        ...
        <th width=15% class="text-center">답변상태</th>
         ...
         <tr v-for="(vo,index) in list">
	        ...
	        <td width=35%>
	          <span style="color: darkred" v-if="id!==vo.userid&&vo.secret===1"><i class="fa fa-lock" aria-hidden="true"></i>&nbsp;비밀글입니다</span>
	        ...
	        <td width=15% class="text-center" style="color: blue" v-if="vo.isreply===0">답변대기</td>
