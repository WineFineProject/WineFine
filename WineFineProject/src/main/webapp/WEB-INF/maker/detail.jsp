...
<body>
<div class="container" id="makerDetail" style="margin-top: 50px">
		<div class="row">
			<div class="col-sm-6">
	       ...
	       <div class="col-sm-6" style="margin-top: 32px">
				...
				<div v-if="mWines.length > 0">	
					<div v-for="(wvo, index) in mWines.slice(0, itemsToShow)" style="margin-bottom: 10px;">
    ...
    <script>
        let makerDetailApp = Vue.createApp({
             ...
             methods: {
            	 getRelatedWines() {
                     axios.get('../maker/relatedWines.do', {
                         params: {
                             no: this.no
                         }
                     }).then(response => {
                    	 console.log(response.data.mWines)
                         this.mWines = response.data.mWines
                     }).catch(error => {
                         console.error(error)
                     })
                 },
