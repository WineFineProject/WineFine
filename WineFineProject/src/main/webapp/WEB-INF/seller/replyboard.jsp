	...
	<div class="row" id="replyBoardList">
		...
		<table class="table table-hover">
			...
			<tr v-for="(vo, index) in list">
				...
				<td width=10% class="text-center"><a v-if="vo.isreply==0" :href="'../seller/replyInsert.do?wrno='+vo.wrno">답변대기</a> <span v-if="vo.isreply==1" style="cursor: pointer;"
					@click="detailAnswer(vo.group_id, index)">답변완료</sapn></td>
			</tr>
		</table>
		<table class="table">
			<tr>
				<td class="text-center">
					<button t class="btn btn-sm btn-danger" @click="replyList(startPage>1?curPage-1:curPage)">이전</button> {{curPage}} page / {{totalPage}} page
				...
				<div class="form-group" style="margin-top: 10px;">
					<table class="table">
						<tr>
							...
							<td width="90%"><span class="form-control">{{cnos[quest.cno]}}</span></td>
						</tr>
						<tr>
							<th width="10%" class="text-center">질문 제목</th>
							<td width="90%"><span class="form-control">{{quest.subject}}</span></td>
						</tr>
						<tr>
							<th width="10%" class="text-center">질문 내용</th>
							<td width="90%"><span class="form-control">{{quest.content}}</span></td>
						</tr>
					</table>
					<div class="form-group" style="margin-top: 10px;">
