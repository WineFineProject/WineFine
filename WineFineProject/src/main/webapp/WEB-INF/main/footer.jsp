		...
		<div class="container py-5">
			<div class="pb-4 mb-4" style="border-bottom: 1px solid rgba(226, 175, 24, 0.5);">
				<div class="row g-4">
					<div class="col-lg-3">
						<a href="#">
							<h1 class="text-wine mb-0">Fruitables</h1>
							<p class="text-wine mb-0">Fresh products</p>
						</a>
					</div>
					<div class="col-lg-6">
			...
			<div class="row g-5">
				<div class="col-lg-3 col-md-6">
					<div class="footer-item">
						...
						<a href="" class="btn border-secondary py-2 px-4 rounded-pill text-wine">Read More</a>
					</div>
				</div>
				<div class="col-lg-3 col-md-6">
